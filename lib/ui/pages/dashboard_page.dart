...
class _DashboardPageState extends State<DashboardPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await context.read<IncubatorProvider>().bootstrap();
      await context.read<TelemetryProvider>().init();
      await context.read<TelemetrySeriesProvider>().fetch();
    });
  }

  Future<void> onRefresh() async {
    await Future.wait([
      context.read<TelemetryProvider>().refreshOnce(),
      context.read<TelemetrySeriesProvider>().fetch(),
